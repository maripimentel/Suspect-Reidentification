...
% if size(resultRectsB)>size(resultRectsA) & size(resultRectsB)>size(resultRectsL)
%    resultRects = resultRectsB;
% else
%     if (size(resultRectsA)>size(resultRectsL))
%         resultRects = resultRectsA;
%     else
%         resultRects = resultRectsL;
%     end
% end
